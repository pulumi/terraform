...
import (
	...
	backendRemote "github.com/pulumi/terraform/pkg/backend/remote"
	backendAzure "github.com/pulumi/terraform/pkg/backend/remote-state/azure"
	backendConsul "github.com/pulumi/terraform/pkg/backend/remote-state/consul"
	backendCos "github.com/pulumi/terraform/pkg/backend/remote-state/cos"
	backendGCS "github.com/pulumi/terraform/pkg/backend/remote-state/gcs"
	backendHTTP "github.com/pulumi/terraform/pkg/backend/remote-state/http"
	backendInmem "github.com/pulumi/terraform/pkg/backend/remote-state/inmem"
	backendKubernetes "github.com/pulumi/terraform/pkg/backend/remote-state/kubernetes"
	backendOSS "github.com/pulumi/terraform/pkg/backend/remote-state/oss"
	backendPg "github.com/pulumi/terraform/pkg/backend/remote-state/pg"
	backendS3 "github.com/pulumi/terraform/pkg/backend/remote-state/s3"
	backendCloud "github.com/pulumi/terraform/pkg/cloud"
)
