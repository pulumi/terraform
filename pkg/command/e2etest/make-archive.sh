...
LDFLAGS="-X github.com/pulumi/terraform/pkg/command/e2etest.terraformBin=./terraform$GOEXE"
...
go test -o "$OUTDIR/e2etest$GOEXE" -c -ldflags "$LDFLAGS" github.com/pulumi/terraform/pkg/command/e2etest
