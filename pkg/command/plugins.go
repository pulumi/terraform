...
import (
	...
	fileprovisioner "github.com/pulumi/terraform/pkg/builtin/provisioners/file"
	localexec "github.com/pulumi/terraform/pkg/builtin/provisioners/local-exec"
	remoteexec "github.com/pulumi/terraform/pkg/builtin/provisioners/remote-exec"
	"github.com/pulumi/terraform/pkg/logging"
	tfplugin "github.com/pulumi/terraform/pkg/plugin"
	"github.com/pulumi/terraform/pkg/plugin/discovery"
