...
//
//     import oauthserver "github.com/pulumi/terraform/pkg/command/testdata/login-oauth-server"
...
import (
	...
	oauthserver "github.com/pulumi/terraform/pkg/command/testdata/login-oauth-server"
)
