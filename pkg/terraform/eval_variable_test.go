...
func TestPrepareFinalInputVariableValue(t *testing.T) {
	...
	cfgSrc := `
		...
		// https://github.com/pulumi/terraform/issues/32152
        ...
        variable "complex_type_with_empty_default_and_nested_optional" {
 		...
 		// https://github.com/pulumi/terraform/issues/32160#issuecomment-1302783910
		...
		// https://github.com/pulumi/terraform/issues/32160
		...
		// https://github.com/pulumi/terraform/issues/32157
		...
		// https://github.com/pulumi/terraform/issues/32109
		...
		// https://github.com/pulumi/terraform/issues/32396
